...
if ($_POST) {
    ...
    if (empty($errors)) {
        $stmt = $pdo->prepare("UPDATE users SET name = ?, email = ?, phone = ?, age = ?, address = ?, status = ? WHERE id = ?");
        if ($stmt->execute([$name, $email, $phone, $age, $address, $status, $id])) {
                        ...
                        <div class="col-lg-8">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mb-0">
                                        <i class="fas fa-edit"></i> Update User Information
                                    </h5>
                                </div>
                                <div class="card-body">
                                    <?php if (!empty($errors)): ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="text-muted">
                                                    <small>
                                                        ...
                                                        Registration Date: <?php echo formatDate($user['registration_date']); ?>
                                                    </small>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
